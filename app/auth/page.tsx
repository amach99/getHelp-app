      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted text-sm">
            {mode === "signin"
              ? "Sign in to help your neighbors."
              : "Start building a culture of daily kindness."}
          </p>
        </div>
        ...
        <div className="card p-8 shadow-xl shadow-slate-200/50">
          ...
          <button
            ...
            disabled={submitting}
            className="w-full flex items-center justify-center gap-3 py-3.5 border border-slate-200 rounded-2xl font-semibold text-slate-700 hover:bg-slate-50 transition-all mb-6 text-sm disabled:opacity-50"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-muted hover:text-slate-700"
                >
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-4 bg-primary hover:bg-primary-dark text-white font-bold rounded-2xl transition-all shadow-lg shadow-primary/20 active:scale-[0.98] disabled:opacity-60 mt-2"
            >
              {submitting
                ? "Please wait..."
                : mode === "signin"
